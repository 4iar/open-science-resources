...
- [NDCT - National Database for Clinical Trials Related to Mental Illness (by the NIMH)](https://data-archive.nimh.nih.gov/ndct/)
- [NIDA Data Share - National Institute on Drug Abuse data repository](https://datashare.nida.nih.gov/)
- [NIDDK (National Institute of Diabetes and Digestive and Kidney Diseases) Central Repository](https://www.niddkrepository.org/home/)
- [NIF - Neuroscience Information Framework, massive search engine for neuroscience data, tools, etc.](http://www.neuinfo.org/)
- [NIH RePORT - Research Portfolio Open Reporting Tools, repository of grants, data, etc.](https://report.nih.gov/)
- [NITRC - NeuroImaging Tools and Resources Collaboratory](https://www.nitrc.org/)
- [OBO Foundry - Open Biological and Biomedical Ontology database](http://www.obofoundry.org/)
...
- [Allen Brain Atlas Data Portal](http://brain-map.org/)
    - [More detail here](http://www.alleninstitute.org/what-we-do/brain-science/research/products-tools/)
- [BEI Resource Repository - Catalog of pathogens, disease agents, etc.](https://www.beiresources.org/)
- [BGAgenomicsDB - Genomics database for cyanobacterial genomes](http://www.bgagenomics.iicb.res.in/)
- [BioLINCC - Biologic Specimen and Data Repository Information Coordinating Center](https://biolincc.nhlbi.nih.gov/home/)
- [BioGRID - Biological General Repository for Interaction Datasets](http://thebiogrid.org/)
- [BrainSlices	- Repository of brain tissue images](https://brainslices.org/)
- [C-BIG - Biological Imaging and Genetic repositiry](http://www.mcgill.ca/c-bigneuro/)
...
- [EMERGE - Electronic medical records and genomics network of tools and databases](http://emerge.mc.vanderbilt.edu/)
- [ENSANUT - (in Spanish) Health and Nutrition National Survey of Mexico](http://ensanut.insp.mx)
- [EuPathDB - Eukaryotic Pathogen Database Resources](http://eupathdb.org/eupathdb/)
- [EumicrobeDB - Microbe and transcriptomics database](http://eumicrobedb.org/)
- [FaceBase - Craniofacial data resource](http://www.facebase.org/)
...
- [G2Aging - Gateway to Global Aging Data](http://www.g2aging.org/)
- [GDC - National Cancer Institute (NCI) Genomic Data Commons (formerly Cancer Genome Atlas)](https://gdc.cancer.gov/)
- [GEO - Gene Ontology Consortium](http://geneontology.org/)
- [GeneNetwork (formerly WebQTL)](http://www.genenetwork.org/webqtl/main.py)
- [Gramene - Ata resource for comparative functional genomics in crops and model plant species](http://www.gramene.org)
- [H-CUP - Healthcare Cost and Utilization Project](http://www.hcup-us.ahrq.gov/)
- [Healthdata.gov - US federal government health database](http://www.healthdata.gov/)
- [IDA LONI - Image and Data Archive for neuroscience by Laboratory of Neuro Imaging](https://ida.loni.usc.edu/login.jsp)
- [ICPSR - Inter-university Consortium for Political and Social Research](https://www.icpsr.umich.edu/icpsrweb/landing.jsp)
- [iDASH - Integrating Data for Analysis, Anonymization, and Sharing](https://idash.ucsd.edu/)
- [iEEG.org - National Institutes of Neurological Disorders and Stroke (NINDS) EEG data repository for epilepsy research](https://www.ieeg.org/)
- [IHEC - International Human Epigenome Consortium Data Portal](http://epigenomesportal.ca/ihec/)
- [ImmPort - Immunology Database and Analysis Portal](http://www.immport.org/immport-open/public/home/home)
- [InterLex - Lexicon of biomedical terms (formerly NeuroLex)](https://scicrunch.org/scicrunch/interlex/dashboard)
- [Intermine - Open-source collection of life science data repositories, and software for hosting your own](http://intermine.org/)
- [IRD - Influenza Research Database](http://www.fludb.org/brc/home.spg?decorator=influenza)
- [ITN TrialShare - Immune Tolerance Network clinical trials research portal](https://www.itntrialshare.org/)
- [KEGG - Kyoto Encyclopedia of Genes and Genomes](http://www.genome.jp/kegg/kegg1.html)
- [KLoSA - (in Korean) Korean Longitudinal Study of Ageing](http://www.kli.re.kr/kli/)
- [LINCS - Library of Integrated Network-based Cellular Signatures](http://www.lincsproject.org/)
- [Metabolomics Workbench - NIH metabolomics database and toolset](http://www.metabolomicsworkbench.org/)
- [MHAS - Mexican Health and Aging Study](http://www.mhasweb.org)
- [miRBase - microRNA database and registry](http://www.mirbase.org)
- [ModelDB - Repository of computational neuroscience models for simulation](https://senselab.med.yale.edu/modeldb/), built by [Senselab](https://senselab.med.yale.edu/)
- [MPD - Mouse Phenome Database](http://phenome.jax.org/)
- [MIMIC-II - Multiparameter Intelligent Monitoring in Intensive Care II, a critical care database](https://mimic.physionet.org)
- [Nanomaterial Registry](https://www.nanomaterialregistry.org/)
- [NAHDAP - National Addiction and HIV Data Archive Program](http://www.icpsr.umich.edu/icpsrweb/NAHDAP/)
...
- [Panther Classification System - for gene ontologies](http://pantherdb.org/)
- [PDBP DMR - Parkinson's Disease Biomarkers Program Data Management Resource](https://pdbp.ninds.nih.gov/)
- [PPMI - Parkinson's Progression Markers Initiative](http://www.ppmi-info.org/)
- [PeptideAtlas - Compendium of peptides from proteomics](http://www.peptideatlas.org/)
- [PhenoExplorer - Search engine for phenotype identification in dbGaP database](http://phenoexplorer.org/)
- [PsychFileDrawer - Repository of psychology replication reports](http://psychfiledrawer.org)
- [PubChem chemical database](http://pubchem.ncbi.nlm.nih.gov/)
- [RCSB PDB - Research Collaboration for Structural Bioinformatics Protein Data Bank](http://www.rcsb.org/pdb/home/home.do)
- [RGD - Rat Genome Database](http://rgd.mcw.edu/wg/home)
- [Reactome - Pathway, protein, and reaction database](http://www.reactome.org)
- [RxNorm - Database of normalized drug names](http://www.nlm.nih.gov/research/umls/rxnorm/)
- [Senselab](https://senselab.med.yale.edu/) hosts several other databases, but [ModelDB](https://senselab.med.yale.edu/modeldb/) is the most popular:
    - [CellPropDB - "Cellular Properties Database provides a simple repository for data regarding membrane channels, receptor and neurotransmitters that are expressed in specific types of cells."](https://senselab.med.yale.edu/CellPropDB/)
    - [NeuronDB - "Provides a dynamically searchable database of three types of neuronal properties: voltage gated conductances, neurotransmitter receptors, and neurotransmitter substances."](https://senselab.med.yale.edu/NeuronDB/)
    - [MicrocircuitDB - "Provides an accessible location for storing and efficiently retrieving realistic computational models of brain microcircuits and networks."](https://senselab.med.yale.edu/MicroCircuitDB/)
    - [3DModelDB  - "A collection of 3D printable versions of published neuron morphologies, both traced and artificial."](https://senselab.med.yale.edu/3DModelDB/)
    - [ORModelDB - "A resource that is a repository of the results of the efforts of the community is computationally elucidating the structure of the olfactory receptor with a view to establishing a mechanistic basis for OR-odorant binding."](https://senselab.med.yale.edu/OrModelDB/)
    - [OdorMapDB - Olfactory Bulb Odor Map DataBase](https://senselab.med.yale.edu/OdorMapDB/)
...
- [SNPedia - Single Nucleotide Polymorphism wiki](http://www.SNPedia.com)
- [TCIA - The Cancer Imaging Archive](http://www.cancerimagingarchive.net/)
...
- [Xenbase - Database of xenopus (frog) information](http://www.xenbase.org/entry/)
